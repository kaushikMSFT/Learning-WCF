...
namespace ClaimsBasedServices
{
    ...
    public class CrudService: ICrudService
    {
       ...
       string ICrudService.CreateSomething()
        {
        ClaimsPrincipalPermission perm = new ClaimsPrincipalPermission(true, ClaimsAuthorizationPolicy.CreateApplicationClaimSet(ClaimsAuthorizationPolicy.ClaimTypes.Create));
          perm.Demand();
        ...
        {
        ClaimsPrincipalPermission perm = new ClaimsPrincipalPermission(true, ClaimsAuthorizationPolicy.CreateApplicationClaimSet(ClaimsAuthorizationPolicy.ClaimTypes.Read));
            perm.Demand();
        ...
        {
        ClaimsPrincipalPermission perm = new ClaimsPrincipalPermission(true, ClaimsAuthorizationPolicy.CreateApplicationClaimSet(ClaimsAuthorizationPolicy.ClaimTypes.Update));
            perm.Demand();
