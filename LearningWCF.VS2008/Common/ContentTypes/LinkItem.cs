...
namespace ContentTypes
{
    ...
    public abstract class LinkItem: IExtensibleDataObject
    {
        ...
        // not a data member, should be set by subclass 
        private LinkItemTypes m_linkItemType;

        public LinkItemTypes LinkItemType
        {
            get { return m_linkItemType; }
            set { m_linkItemType = value; }
        }
