...
namespace WinClient.localhost1
{
    ...
    public interface ICounterServiceSession
    {
        ...
        [System.ServiceModel.OperationContractAttribute(Action="http://www.thatindigogirl.com/samples/2006/06/ICounterServiceSession/IncrementCou" +
            "nter", ReplyAction="http://www.thatindigogirl.com/samples/2006/06/ICounterServiceSession/IncrementCou" +
            "nterResponse")]
        int IncrementCounter();
        
        [System.ServiceModel.OperationContractAttribute(IsOneWay=true,  Action="http://www.thatindigogirl.com/samples/2006/06/ICounterServiceSession/ThrowExcepti" +
            "on")]
        void ThrowException();
    }
